...
<head>
    ...
    <title>Processo Aprovado - SEMA</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Temos uma boa notícia! Seu requerimento foi analisado pela equipe técnica da Secretaria Municipal de Meio Ambiente e <strong>aprovado para emissão do alvará</strong>.</p>

        <div class="status-box">
            <div class="icon">✅</div>
            <div class="label">Processo Aprovado</div>
