                ...
                `;
                    ...
                    if (tipo === 'construcao') {
                        ...
                        campos = `
                            ...
                            <div class="form-grid-2">
                                <input ${tiposExigemDO.includes(tipo) ? 'required' : ''} name="publicacao_diario_oficial" placeholder="Dados da publicação em Diário Oficial${tiposExigemDO.includes(tipo) ? ' *' : ' (opcional)'}">
