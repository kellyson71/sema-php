...
return [
    ...
    'blocos' => [
        ...
        [
            'tipo'   => 'paragrafos',
            'textos' => [
                'O presente parecer tem como objetivo a análise técnica ambiental para emissão de Alvará de Construção, referente à <strong>{{especificacao}}</strong>, a ser executada no imóvel no endereço supracitado, de acordo com <strong>{{responsavel_tecnico_rotulo}} Nº {{responsavel_tecnico_numero}}</strong>.',
