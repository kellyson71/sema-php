...
return [
    ...
    'blocos' => [
        ...
        [
            'tipo'     => 'texto',
            'conteudo' => '<p style="text-align:justify; margin:0 0 16px 0;">'
                ...
                . '</p>'
                . '<div style="margin:0 0 16px 0;">{{desmembramento_lotes_html}}</div>'
                . '<p style="text-align:justify; margin:0;">ESTE DESMEMBRAMENTO É AUTORIZADO EM CONFORMIDADE COM A LEI Nº 6.766 '
