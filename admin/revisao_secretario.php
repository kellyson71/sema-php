...
async function iniciarVerificacaoAssinaturaSecretario() {
    ...
    // Verificações de segurança do 2FA agora ocorrem na etapa de login.
    // Desta forma o secretário já está liberado para emitir o alvará a qualquer momento de sua sessão (24h de validade no back-end).
...
<!-- Modal de verificação de segurança removido pois foi migrado para o fluxo de login -->
